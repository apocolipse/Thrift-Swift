...
public class TAsyncSocketTransport: TSocketTransport, TAsyncTransport {
  ...
  public override func read(size: Int) -> Data {
    var buff = Data()
    bufferLock.sync {
