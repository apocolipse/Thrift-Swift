...
// Primative extensions to write as value typed Data

extension UInt8 {
  init?(data: Data) {
    guard case data.count = 1 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> UInt8 in
      return ptr.pointee
    }
  }
...
extension UInt16 {
  init?(data: Data) {
    guard case data.count = 2 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> UInt16 in
      return UnsafePointer<UInt16>(OpaquePointer(ptr)).pointee
    }
  }
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(to: &mutable) {
      return Data(bytes: UnsafePointer<UInt8>(OpaquePointer($0)
      ), count: 2)
    }
  }
}
...
extension UInt32 {
  init?(data: Data) {
    guard case data.count = 4 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> UInt32 in
      return UnsafePointer<UInt32>(OpaquePointer(ptr)).pointee
    }
  }
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(to: &mutable) {
      return Data(bytes: UnsafePointer<UInt8>(OpaquePointer($0)), count: 4)
    }
  }
}
...
extension UInt64 {
  init?(data: Data) {
    guard case data.count = 8 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> UInt64 in
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(to: &mutable) {
      return Data(bytes: UnsafePointer<UInt8>(OpaquePointer($0)), count: 8)
    }
  }
}
...
extension Double {
  init?(data: Data) {
    guard case data.count = 8 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Double in
      return UnsafePointer<Double>(OpaquePointer(ptr)).pointee
    }
  }
...
extension Int8 {
  init?(data: Data) {
    guard case data.count = 1 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Int8 in
      return UnsafePointer<Int8>(OpaquePointer(ptr)).pointee
    }
  }
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(to: &mutable) {
      return Data(bytes: UnsafePointer<UInt8>(OpaquePointer($0)), count: 1)
    }
  }
}
...
extension Int16 {
  init?(data: Data) {
    guard case data.count = 2 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Int16 in
      return UnsafePointer<Int16>(OpaquePointer(ptr)).pointee
    }
  }
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(to: &mutable) {
      return Data(bytes: UnsafePointer<UInt8>(OpaquePointer($0)), count: 2)
    }
  }
}
...
extension Int32 {
  init?(data: Data) {
    guard case data.count = 4 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Int32 in
      return UnsafePointer<Int32>(OpaquePointer(ptr)).pointee
    }
  }
...
extension Int64 {
  init?(data: Data) {
    guard case data.count = 8 else { return nil }
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Int64 in
      return UnsafePointer<Int64>(OpaquePointer(ptr)).pointee
    }
  }
